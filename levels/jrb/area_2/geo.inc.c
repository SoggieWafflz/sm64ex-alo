...
const GeoLayout jrb_area_2_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(1, -3700, -7292, 2143, jrb_dl_Cube_017_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, -3665, -7292, 2070, jrb_dl_Cube_018_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, 1121, -1156, -998, jrb_dl_DL_cotmc_1_0xe114b20_Obj_001_mesh_layer_1),
		GEO_OPEN_NODE(),
