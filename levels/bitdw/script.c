...
const LevelScript level_bitdw_entry[] = {
	...
	AREA(1, bitdw_area_1),
		...
		OBJECT(MODEL_BITS_WARP_PIPE, 4294, -111, 2278, 0, -13, 0, 0x210000, bhvWarpPipe),
	...
	AREA(2, bitdw_area_2),
		...
		WARP_NODE(0x12, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(241, LEVEL_BITDW, 0x01, 0x1C, WARP_NO_CHECKPOINT),
		WARP_NODE(240, LEVEL_BITDW, 0x01, 0x1B, WARP_NO_CHECKPOINT),
		...
		OBJECT(255, -1055, 3032, -817, 0, 90, 0, 0x10000, bhvGlowRot),
		...
		OBJECT(57, 10845, 8032, -331, 0, 0, 0, 0x10000, bhvFerrisWheelAxle),
		...
		OBJECT(57, -1055, 2823, -4, 0, -90, 0, 0x10000, bhvFerrisWheelAxle),
		OBJECT(255, -1055, 3032, 1171, 0, 90, 0, 0x10000, bhvGlowRot),
		OBJECT(57, 5345, 9381, 1031, 0, 90, 0, 0x10000, bhvFerrisWheelAxle),
		...
		OBJECT(215, 12045, 7729, 16, 0, 0, 0, 0x0, bhvRedCoin),
		...
		OBJECT(215, -2896, -4307, 597, 0, 0, 0, 0x0, bhvRedCoin),
		...
		OBJECT(MODEL_BITDW_WARP_PIPE, 2, 10337, 4, 0, 0, 0, 0x210000, bhvWarpPipe),
		OBJECT(252, -15, 3099, -4, 0, 90, 0, 0x10000, bhvPlusRot),
