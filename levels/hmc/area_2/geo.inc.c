...
const GeoLayout hmc_area_2_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(1, -1573, -7195, -2579, hmc_dl_DL_bob_1_0xe01b220_Obj_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(4, hmc_dl_DL_bob_1_0xe01b220_Obj_mesh_layer_4),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout hmc_area_2[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(1, 0, 0, 3257, 0, -100, 3257, geo_camera_main),
				GEO_OPEN_NODE(),
