...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(137, 1191, -1907, 14541, 0, 0, 0, 0x00000, bhvExclamationBox),
		...
		OBJECT(124, 6372, -7131, 10264, 0, -9, 0, 0x1E0000, bhvMessagePanel),
	...
	AREA(2, hmc_area_2),
		...
		OBJECT(0, -2521, -5372, -3898, 90, 0, 90, 0x130000, bhvCoinFormation),
		...
		OBJECT(0, -225, -8680, -3936, 180, 0, -45, 0x110000, bhvCoinFormation),
		OBJECT(0, -1255, -3858, 1033, 180, 0, 0, 0x110000, bhvCoinFormation),
		OBJECT(0, -4867, -8143, -1162, 180, 0, 0, 0x110000, bhvCoinFormation),
		...
		OBJECT(180, -5764, -6960, -2673, 180, 0, 0, 0x0, bhvFireSpitter),
		OBJECT(180, -5028, -8120, -1790, 180, 0, 0, 0x0, bhvFireSpitter),
		OBJECT(192, -282, -8028, -1174, -1, 0, 0, 0x0, bhvGoomba),
		OBJECT(192, -899, -8028, -1223, 0, 0, 0, 0x0, bhvGoomba),
		OBJECT(0, -2281, -8209, -7092, 180, 0, 0, 0x0, bhvGoombaTripletSpawner),
		OBJECT(0, -1612, -8209, -6288, 180, 0, 0, 0x0, bhvGoombaTripletSpawner),
		OBJECT(124, -1675, -5033, 956, 0, -89, 0, 0x001F0000, bhvMessagePanel),
		OBJECT(124, 1941, -8209, -2415, 0, -94, 0, 0x220000, bhvMessagePanel),
		OBJECT(120, -5004, -6390, -1199, 180, 0, 0, 0x0, bhvRecoveryHeart),
		OBJECT(120, -2192, -5070, 587, 180, 0, 0, 0x0, bhvRecoveryHeart),
		...
		OBJECT(215, 1060, -8769, -5258, 180, 0, 0, 0x0, bhvRedCoin),
		OBJECT(215, -2472, -8143, -1103, 180, 0, 0, 0x0, bhvRedCoin),
		OBJECT(215, -3083, -7429, 388, 180, 0, 0, 0x0, bhvRedCoin),
		OBJECT(215, -4514, -7027, 1301, 180, 0, 0, 0x0, bhvRedCoin),
		OBJECT(0, -4968, -7929, -6561, 0, 0, 0, 0x220000, bhvSpinAirborneWarp),
		OBJECT(24, -2103, -8209, -5574, 180, 0, 0, 0x0, bhvTree),
		OBJECT(24, -1076, -8209, -6823, 180, 0, 0, 0x0, bhvTree),
		OBJECT(24, 2316, -8209, -7181, 180, 0, 0, 0x0, bhvTree),
		OBJECT(252, -4475, -7724, -3128, 0, 0, 0, 0x0, bhvPlusRot),
		OBJECT(255, -4116, -7450, -2912, 0, 16, 0, 0x0, bhvGlowRot),
		OBJECT(MODEL_STAR, 1516, -4212, -5694, 0, 0, 0, 0x02000001, bhvStar),
		OBJECT(MODEL_STAR, -1807, -6760, 1176, 180, 31, 0, 0x03000001, bhvStar),
		OBJECT(0, -4692, -7653, 988, 180, 0, 0, 0x4000001, bhvHiddenRedCoinStar),
		OBJECT(0, -4953, -8189, -6876, 0, 0, 0, 0x210000, bhvFadingWarp),
		OBJECT(MODEL_EXCLAMATION_BOX, -5004, -6268, -1445, 180, 0, 0, 0x0, bhvExclamationBox),
		OBJECT(MODEL_EXCLAMATION_BOX, -2615, -5234, -4090, 180, 0, 0, 0x0, bhvExclamationBox),
