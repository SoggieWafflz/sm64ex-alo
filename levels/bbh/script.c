...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_STAR, 5388, -965, 7218, 0, 0, 0, 0x1, bhvHiddenStarTrigger),
		...
		OBJECT(255, 1392, -403, -1250, 0, 0, 0, 0x0, bhvGlowRot),
		...
		OBJECT(MODEL_NONE, 5388, -726, 7218, 0, 0, 0, 0x1, bhvHiddenStar),
