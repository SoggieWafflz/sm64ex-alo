...
const MacroObject castle_grounds_seg7_macro_objs[] = {
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_wooden_signpost,     /*yaw*/ 262, /*pos*/  5288,   722,  -800, /*behParam*/ 0),
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_wooden_signpost,     /*yaw*/  90, /*pos*/  1740,    35,  2500, /*behParam*/ 0),
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_wooden_signpost,     /*yaw*/   0, /*pos*/ -1566,   260,  3503, /*behParam*/ 0),
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_wooden_signpost,     /*yaw*/  82, /*pos*/ -4666,   260,   922, /*behParam*/ 0),
