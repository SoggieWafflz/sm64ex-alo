...
const LevelScript level_castle_courtyard_entry[] = {
	...
	AREA(1, castle_courtyard_area_1),
		...
		WARP_NODE(241, LEVEL_CASTLE_COURTYARD, 1, 0xB, WARP_NO_CHECKPOINT),
		WARP_NODE(240, LEVEL_CASTLE, 1, 0xB, WARP_NO_CHECKPOINT),
		WARP_NODE(0xB, LEVEL_BOB, 1, 0xB, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x11, LEVEL_CASTLE_COURTYARD, 0x01, 0x12, WARP_NO_CHECKPOINT),
		...
		OBJECT_WITH_ACTS(0, 53, -383, -121, 0, 0, 0, 0xB0000, bhvAirborneDeathWarp, ACT_1 | ACT_2 | ACT_3 | ACT_4 | ACT_5),
		...
		OBJECT_WITH_ACTS(0, 10, -360, -74, 0, 0, 0, 0xA0000, bhvAirborneWarp, ACT_1 | ACT_2 | ACT_3 | ACT_4 | ACT_5),
		OBJECT_WITH_ACTS(0, 10, -360, -74, 0, 0, 0, 0x120000, bhvAirborneWarp, ACT_1 | ACT_2 | ACT_3 | ACT_4 | ACT_5),
