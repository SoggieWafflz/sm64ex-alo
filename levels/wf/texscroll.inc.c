void scroll_wf_dl_DL_sl_1_0xe0bca40_Obj_001_mesh_layer_1_vtx_21() {
	int i = 0;
	int count = 184;
	int width = 32 * 0x20;
	int height = 64 * 0x20;
	...
	int deltaY;
	Vtx *vertices = segmented_to_virtual(wf_dl_DL_sl_1_0xe0bca40_Obj_001_mesh_layer_1_vtx_21);
...
void scroll_wf() {
	scroll_wf_dl_DL_sl_1_0xe0bca40_Obj_001_mesh_layer_1_vtx_21();
