...
const LevelScript level_bowser_3_entry[] = {
	...
	AREA(1, bowser_3_area_1),
		...
		WARP_NODE(0x00, LEVEL_SA, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_BOWSER_BOMB, 0, -445, -2295, 0, 0, 0, 0, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, 0, -445, 2326, 0, 0, 0, 0, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, 2583, -445, 7, 0, 0, 0, 0, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, -2566, -445, 7, 0, 0, 0, 0, bhvBowserBomb),
