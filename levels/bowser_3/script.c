...
const LevelScript level_bowser_3_entry[] = {
	...
	AREA(1, bowser_3_area_1),
		...
		OBJECT(MODEL_BOWSER_BOMB, -1, -445, -3006, 0, 0, 0, 0, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, -1, -445, 3005, 0, 0, 0, 0, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, 3026, -445, 8, 0, 0, 0, 0, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, -3007, -445, 8, 0, 0, 0, 0, bhvBowserBomb),
