...
const GeoLayout bowser_3_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(1, -2548, -1053, 3677, bowser_3_dl_NurbsPath_001_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, -2548, -1053, 3677, bowser_3_dl_NurbsPath_002_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout bowser_3_area_1[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(CAMERA_MODE_8_DIRECTIONS, 0, 0, 0, 0, -285, 0, geo_camera_main),
				GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(5, bowser_3_dl_material_revert_render_settings),
