...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_CASTLE_STAR_DOOR_30_STARS, -7626, -865, 79, 0, 90, 0, 0x01000000, bhvStarDoor),
		OBJECT(MODEL_CASTLE_STAR_DOOR_30_STARS, -7626, -865, -75, 0, -90, 0, 0x01000000, bhvStarDoor),
	...
	AREA(2, castle_inside_area_2),
		...
		OBJECT(MODEL_BITDW_WARP_PIPE, -5763, 1707, 5505, 0, -180, 0, 0x00110000, bhvWarpPipe),
		OBJECT(MODEL_BITDW_WARP_PIPE, -5785, 1707, -5449, 0, -180, 0, 0x00210000, bhvWarpPipe),
		OBJECT(MODEL_BITDW_WARP_PIPE, -2727, 2136, 2905, 0, -180, 0, 0x00310000, bhvWarpPipe),
		OBJECT(MODEL_BITDW_WARP_PIPE, -2727, 2136, -2853, 0, -180, 0, 0x00410000, bhvWarpPipe),
		...
		OBJECT(MODEL_NONE, -7126, 2243, 0, 0, -90, 0, 0x000A0000, bhvAirborneWarp),
