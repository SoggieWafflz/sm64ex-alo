...
const BehaviorScript bhvSpikeRot[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_COLLISION_DATA(SpikeRot_collision),
    SET_INT(oAngleVelYaw,0x20),
    SET_FLOAT(oCollisionDistance, 3000),
    SET_FLOAT(oDrawingDistance, 20000),
	CALL_NATIVE(bhvrandrot),
    BEGIN_LOOP(),
		ADD_INT(oFaceAngleYaw,0x20),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};
const BehaviorScript bhvDiamondRot[] = {
    ...
    SET_INT(oAngleVelPitch,0x42),
    SET_INT(oAngleVelYaw,0x70),
    SET_INT(oAngleVelRoll,0x12),
    SET_FLOAT(oCollisionDistance, 3000),
    SET_FLOAT(oDrawingDistance, 20000),
	CALL_NATIVE(bhvrandrot),
    BEGIN_LOOP(),
		ADD_INT(oFaceAnglePitch,0x42),
		ADD_INT(oFaceAngleYaw,0x70),
		ADD_INT(oFaceAngleRoll,0x12),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};
